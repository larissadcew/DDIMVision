...
def create_cifar10_dataset(data_path, batch_size, **kwargs):
    ...
    # Create the CIFAR-10 dataset with specified transformations
    dataset = CIFAR10(root=data_path, train=train, download=download, transform=transforms.Compose([
        ...
        transforms.Normalize((0.5, 0.5, 0.5), (0.5, 0.5, 0.5))  # Normalize images with mean and std deviation of 0.5
    ]))
